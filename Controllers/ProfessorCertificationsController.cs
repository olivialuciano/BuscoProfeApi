using BuscoProfe.Api.DTOs.ProfessorCertifications;
...
public class ProfessorCertificationsController : ControllerBase
{
    private readonly IProfessorCertificationRepository _repository;
    private readonly IUserRepository _userRepository;

    public ProfessorCertificationsController(
        IProfessorCertificationRepository repository,
    ...
    public async Task<ActionResult<List<ProfessorCertification>>> GetByUserId(int userId)
    {
    ...
    [HttpPost]
    [Authorize(Roles = nameof(UserRole.Professor) + "," + nameof(UserRole.Admin))]
    public async Task<ActionResult> Create(CreateProfessorCertificationDto dto)
    {
        var loggedUserId = ClaimsHelper.GetUserId(User);
        var loggedRole = ClaimsHelper.GetRole(User);
        ...
        var entity = new ProfessorCertification
        {
            UserId = dto.UserId,
            Name = dto.Name,
            Issuer = dto.Issuer,
